...
import { DelegadosVaguada } from './DelegadosVaguada';
import { InfoVaguada } from './InfoVaguada';

export const Vaguada = ({ name, url }) => {
  ...
  return (
    <div>
      ...
      <DelegadosVaguada name={name} showInfoDelegados={showInfoDelegados} setShowFooterChat={setShowFooterChat} />
      <InfoVaguada showInfoInfo={showInfoInfo} />
