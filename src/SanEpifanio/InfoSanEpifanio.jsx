...
export const InfoSanEpifanio = ({ showInfoInfo }) => {
    return (
        <div className={showInfoInfo ? 'show' : 'hide'}>
            ...
            <div className='links-box2'>
                <Link to='mailto:cesar.cordido@moovecars.com'>
                    <div className='link'>
