...
import { DelegadosVistalegre } from './DelegadosVistalegre';
import { InfoVistalegre } from './InfoVistalegre';

export const Vistalegre = ({ name, url }) => {
  ...
  return (
    <div>
      ...
      <DelegadosVistalegre name={name} showInfoDelegados={showInfoDelegados} setShowFooterChat={setShowFooterChat} />
      <InfoVistalegre showInfoInfo={showInfoInfo} />

      {showInfoDelegados && !showFooterChat ? <Footer id='footer-main' mainFooter={'setFooter'} /> : null}
