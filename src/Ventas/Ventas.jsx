...
import { DelegadosVentas } from './DelegadosVentas';
import { InfoVentas } from './InfoVentas'

export const Ventas = ({ name, url }) => {
  ...
  return (
    <div>
      ...
      <DelegadosVentas name={name} showInfoDelegados={showInfoDelegados} setShowFooterChat={setShowFooterChat} />
      <InfoVentas showInfoInfo={showInfoInfo} />
