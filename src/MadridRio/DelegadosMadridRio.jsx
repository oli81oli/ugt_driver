    ...
    return (
        <div className={showInfoDelegados ? 'show' : 'hide'}>
            ...
            <div className='profile-container'>
                ...
                <ContactBox props={{ name: 'Daniel', status: 'de Comité', src: 'https://res.cloudinary.com/dpflfpgcj/image/upload/v1777557066/kwr95i7pkb7lwlpfat62.jpg', phone: '34609104030' }} />
                ...
                <ContactBox props={{ name: 'Consuelo', status: 'de Comité', src: 'https://res.cloudinary.com/dpflfpgcj/image/upload/v1777557056/r3mk0aryo4mbmeq9qjg1.jpg', phone: '34633241085' }} />
                <ContactBox props={{ name: 'Felipe', status: 'de Comité', src: 'https://res.cloudinary.com/dpflfpgcj/image/upload/v1777557073/byjrh7ruhhrouxsrlvqa.jpg', phone: '34627561990' }} />
