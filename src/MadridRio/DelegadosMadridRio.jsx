    ...
    return (
        <div className={showInfoDelegados ? 'show' : 'hide'}>
            ...
            <div className='profile-container'>
                ...
                <ContactBox props={{ name: 'Daniel', status: 'de Comité', src: 'https://res.cloudinary.com/dpflfpgcj/image/upload/v1701871263/uploads/v8xummfbqaofoq3w7jou.png', phone: '34609104030' }} />
                ...
                <ContactBox props={{ name: 'Consuelo', status: 'de Comité', src: 'https://res.cloudinary.com/dpflfpgcj/image/upload/v1701871263/uploads/v8xummfbqaofoq3w7jou.png', phone: '34633241085' }} />
                <ContactBox props={{ name: 'Felipe', status: 'de Comité', src: 'https://res.cloudinary.com/dpflfpgcj/image/upload/v1701871263/uploads/v8xummfbqaofoq3w7jou.png', phone: '34627561990' }} />
