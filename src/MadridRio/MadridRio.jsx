...
import { DelegadosMadridRio } from './DelegadosMadridRio';
import { InfoMadridRio } from './InfoMadridRio';

export const MadridRio = ({ name, url }) => {
  ...
  return (
    <div>
      ...
      <DelegadosMadridRio name={name} showInfoDelegados={showInfoDelegados} setShowFooterChat={setShowFooterChat} />
      <InfoMadridRio showInfoInfo={showInfoInfo} />
